# Generated by Django 5.0.6 on 2024-06-24 21:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='task',
            name='labels',
            field=models.ManyToManyField(blank=True, related_name='label', through='tasks.LabelAndTaskRelation', to='labels.label'),
        ),
        migrations.AddField(
            model_name='task',
            name='status',
